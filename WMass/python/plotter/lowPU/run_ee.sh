...
#python mcPlots.py -f lowPU/cfg/mca.txt lowPU/cfg/zee_data_cuts.txt lowPU/cfg/zee_plots.txt -P /eos/cms/store/cmst3/group/wmass/LowPU/Nano_0302/  -p "data" --pg "data := data_eg" -j 8  --nanoaod-tree --rdf-define-file lowPU/cfg/zee_data_defines.txt -v 3 --json lowPU/lumiPileup/Cert_306896-307082_13TeV_PromptReco_Collisions17_JSON_LowPU_lowPU_suppressedHighPULS.txt  --skipPlot --out /eos/user/j/jaeyserm/www/wmass/test//data_Zee.root --lumi-weight 1.0

python mcPlots.py -f lowPU/cfg/mca.txt lowPU/cfg/zee_mc_cuts.txt lowPU/cfg/zee_plots.txt -P /eos/cms/store/cmst3/group/wmass/LowPU/Nano_0302/ -p "DY" -j 8  --nanoaod-tree --rdf-define-file lowPU/cfg/zee_mc_defines.txt -v 3 --skipPlot --out /eos/user/j/jaeyserm/www/wmass/test//DY_Zee.root --lumi-weight 1.0 -W "lepSF*prefireSF"

#python mcPlots.py -f lowPU/cfg/mca.txt lowPU/cfg/zee_mc_cuts.txt lowPU/cfg/zee_plots.txt -P /eos/cms/store/cmst3/group/wmass/LowPU/Nano_0302/ -p "TT2l,TT1l,TT0l" -j 8  --nanoaod-tree --rdf-define-file lowPU/cfg/zee_mc_defines.txt --rdf-alias "goodMuonsCharge: goodMuonsPlus:.*" --rdf-alias "goodMuonsOther: goodMuonsMinus:.*" -v 3 --skipPlot --out /eos/user/j/jaeyserm/www/wmass/test//TT_Zee.root --lumi-weight 1.0 -W "lepSF"

#python mcPlots.py -f lowPU/cfg/mca.txt lowPU/cfg/zee_mc_cuts.txt lowPU/cfg/zee_plots.txt -P /eos/cms/store/cmst3/group/wmass/LowPU/Nano_0302/ -p "WJets0J,WJets1J,WJets2J" -j 8  --nanoaod-tree --rdf-define-file lowPU/cfg/zee_mc_defines.txt --rdf-alias "goodMuonsCharge: goodMuonsPlus:.*" --rdf-alias "goodMuonsOther: goodMuonsMinus:.*" -v 3 --skipPlot --out /eos/user/j/jaeyserm/www/wmass/test//WJets_Zee.root --lumi-weight 1.0 -W "lepSF"

#python mcPlots.py -f lowPU/cfg/mca.txt lowPU/cfg/zee_mc_cuts.txt lowPU/cfg/zee_plots.txt -P /eos/cms/store/cmst3/group/wmass/LowPU/Nano_0302/ -p "WW,WZ,ZZ" -j 8  --nanoaod-tree --rdf-define-file lowPU/cfg/zee_mc_defines.txt --rdf-alias "goodMuonsCharge: goodMuonsPlus:.*" --rdf-alias "goodMuonsOther: goodMuonsMinus:.*" -v 3 --skipPlot --out /eos/user/j/jaeyserm/www/wmass/test//VV_Zee.root --lumi-weight 1.0 -W "lepSF"
